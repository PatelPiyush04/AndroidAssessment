...
public class LivestockRecyclerViewAdapter extends CustomRecyclerViewAdapter<LivestockRecyclerViewAdapter.ViewHolder> {
    ...
    public LivestockRecyclerViewAdapter(Context context, List<EntityLivestock> items, LivestockInterface listener) {
        mContext = context;
        mValues = items;
        mListener = listener;
    ...
    public LivestockRecyclerViewAdapter(Context context, List<EntityLivestock> items, LivestockInterface listener, Integer viewType) {
        mContext = context;
        mValues = items;
        mListener = listener;
        mViewType = viewType;
