...
public class SaleyardPagerViewModel extends PagerViewModel<EntitySaleyard, ResPagerSaleyard> {

    final Integer mUserId;
    final UserType mUserType;


    public SaleyardPagerViewModel(@NonNull Application application, SearchFilter searchFilter) {
        super(application);
    ...
    public Call<ResPagerSaleyard> requestCall(Integer currentPage, SearchFilter filter, RequestCommaValue requestInclude) {
            return mRetrofitClient.getPublicSaleyard(filter,currentPage);
    }
    ...
    public static class Factory extends ViewModelProvider.NewInstanceFactory {
        ...
        public <T extends ViewModel> T create(Class<T> modelClass) {
            ...
            return (T) new SaleyardPagerViewModel(mApplication, mSearchFilter);
        }
    }
