...
public class PhotoSaleyardRecyclerViewAdapter extends RecyclerView.Adapter<PhotoSaleyardRecyclerViewAdapter.ViewHolder> {
    ...
    public PhotoSaleyardRecyclerViewAdapter(MainActivity mainActivity, List<Media> items, OnClickPhotoInterface photoListener) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        if  (position == 0)
        {
            ...
            holder.binding.image.setOnClickListener(l->{
                mMainActivity.popupMediaDialog(AppConstants.ACTIVITY_CODE_POST_SALEYARD_TAKE_PHOTO);
            });
        }
        else
        {
