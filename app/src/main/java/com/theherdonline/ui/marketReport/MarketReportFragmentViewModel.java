...
public class MarketReportFragmentViewModel extends AndroidViewModel {
    ...
    public MarketReportFragmentViewModel(@NonNull Application application, DataRepository repository) {
        super(application);
    ...
    public static class Factory extends ViewModelProvider.NewInstanceFactory {
        ...
        public <T extends ViewModel> T create(Class<T> modelClass) {
            ...
            return (T) new MarketReportFragmentViewModel(mApplication, mDataRepository);
        }
    }
