...
public class PickupUserDialogFragment extends DialogFragment {
    ...
    public static PickupUserDialogFragment newInstance(String mTitle, List<User> list, OnSelectedItemListener onDateSetListener) {
        PickupUserDialogFragment pickerFragment = new PickupUserDialogFragment();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        UserListAdapter  adapter = new UserListAdapter(getContext(),mList);
