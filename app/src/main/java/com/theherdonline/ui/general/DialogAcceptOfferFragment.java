...
public class DialogAcceptOfferFragment extends DialogFragment {
    ...
    public static DialogAcceptOfferFragment newInstance(Integer producerId, Integer livestockId, AcceptOfferInterface offerInterface,
                                                        String title, String des) {
        DialogAcceptOfferFragment pickerFragment = new DialogAcceptOfferFragment();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final View dialogView = inflater.inflate(R.layout.dialog_accept_offer, null);
