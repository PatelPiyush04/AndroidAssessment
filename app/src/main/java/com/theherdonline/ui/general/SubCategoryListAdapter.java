...
public class SubCategoryListAdapter extends ArrayAdapter<LivestockSubCategory> {

    private List<LivestockSubCategory> mSaleyardList;

    public SubCategoryListAdapter(Context context, List<LivestockSubCategory> objects) {
